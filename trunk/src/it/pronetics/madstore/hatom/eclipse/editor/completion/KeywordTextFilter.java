/*
 * ---------------------------------------------------------------------------------
 * KeywordTextFilter.java - History of changes
 * ---------------------------------------------------------------------------------
 * 05/09/2008 - 1.0: First implementation.
 * 06/11/2008 - 1.1: Port and refactoring from Netbeans version.
 * 07/11/2008 - 1.2: Modified exception handling: now it writes on Eclipse Error log.
 * 17/11/2008 - 1.3: Renamed class: from Filter to keywordtextFilter
 * 24711/2008 - 1.4: Added method countCharOccurrences(String s, char c)
 */
