 ...
 * ---------------------------------------------------------------------------------
 * 26/09/2008 - 1.0: First implementation.
 * 06/10/2008 - 1.1: Added remove method
 */
...
public class ValidatorCache {
    ...
    /**
     * Creates a validation engine for the document named <code>documentName</code> and stores it in the
     * cache.<br>
