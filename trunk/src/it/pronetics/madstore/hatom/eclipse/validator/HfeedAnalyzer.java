/*
 * ---------------------------------------------------------------------------------
 * HfeedAnalyzer.java - History of changes
 * ---------------------------------------------------------------------------------
 * 23/09/2008 - 1.0: First implementation.
 * 06/10/2008 - 1.1: Removed NodeMetadata references: used Node instead
 * 18/11/2008 - 1.2: Implemented feed-key handling. Changed getFeedState in evalFeedState
 *                   which, now has a void return type (was int).
 * 20/11/2008 - 1.3: Added feed-key precedence check (must be placed before any hentry element)
 */
...
import static it.pronetics.madstore.hatom.eclipse.validator.ValidatorEngine.ALL_KEYWORDS;
