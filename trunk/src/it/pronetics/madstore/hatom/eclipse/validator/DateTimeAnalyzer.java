 ...
 * 21/11/2008 - 1.1: Changed hardcoded value with constant
 */
...
public class DateTimeAnalyzer extends HentryChildAnalyzer {
    ...
    // Regular expression that validates the date pattern YYYY-MM-DDTHH:MM:SSZ. Right now it does not validate
    // the date value.
    ...
    private boolean isAbbrNode() {
        // Node name should never be null: in case of non-element node, it should return #text or similar
        // meta-names
