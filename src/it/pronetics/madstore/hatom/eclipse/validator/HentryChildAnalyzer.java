/*
 * ---------------------------------------------------------------------------------
 * HentryChildAnalyzer.java - History of changes
 * ---------------------------------------------------------------------------------
 * 24/09/2008 - 1.0: First implementation.
 * 06/10/2008 - 1.1: Fixed bug in searchInvalidAttributes()
 * 07/10/2008 - 1.2: Fixed bug in searchInvalidAttributes()
 * 07/10/2008 - 1.3: Added attributeName and attributeValue from BaseAnalyzer
 * 20/11/2008 - 1.4: Changed ALL_KEYWORDS initialization.
 * 10/12/2008 - 1.5: Moved ALL_KEYWORDS to ValidatorEngine
 */
...
public class HentryChildAnalyzer extends BaseAnalyzer {
    ...
    /**
     * Returns the attribute name of a node, usually class or rel. Used by subclasses that perform spcific
     * validation on simple nodes.
    ...
    /**
     * Setss the attribute name of a node, usually class or rel. Used by subclasses that perform spcific
     * validation on simple nodes.
    ...
    /**
     * Returns the attribute value of a node. Used by subclasses that perform spcific validation on simple
     * nodes.
    ...
    /**
     * Setss the attribute value of a node. Used by subclasses that perform spcific validation on simple
     * nodes.
     * @return the attribute value
     */
     ...
     * <br>
     * Note:</b>This method MUST be inovked after it's already known that the node has not a valid hAtom
     * keyword.<br>
