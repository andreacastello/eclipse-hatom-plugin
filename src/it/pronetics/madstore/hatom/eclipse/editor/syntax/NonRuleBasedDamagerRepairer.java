/*
 * ---------------------------------------------------------------------------------
 * NonRuleBasedDamagerRepairer.java - History of changes
 * ---------------------------------------------------------------------------------
 * 31/10/2008 - 1.0: First implementation
 * 07/11/2008 - 1.1: getDamageRegion() log excpetion on Eclipse Error log (as a warning)
 */
...
/**
 * Infrastructure class created by Eclipse PDE. Added a custom exception logging.<br>
 * @version 1.1
 */
    ...
    public IRegion getDamageRegion(ITypedRegion partition, DocumentEvent event, boolean documentPartitioningChanged) {
        if (!documentPartitioningChanged) {
            try {
                ...
                Status status = new Status(Status.WARNING, HatomActivator.PLUGIN_ID, this.getClass().getName() + ".getDamageRegion() generated an exception", x);
